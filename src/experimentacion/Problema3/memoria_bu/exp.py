...
archivo_salida = path + "tp1Nuevo/src/experimentacion/Problema3/memoria_bu/salida"
...
sys.stdout.write("\n")
sys.stdout.write("----------------------------------------------------\n")
sys.stdout.write("-------------MEMORIA BOTTOM UP----------------------\n")
sys.stdout.flush()
...
while tesoros < maximo_tesoros:
	for i in xrange(0,cant_repeticiones):
		...
		status, memoria = commands.getstatusoutput("cat "+path+"tp1Nuevo/src/experimentacion/Problema3/caso.in | java -cp "+path+"tp1Nuevo/src/ soluciones/Ej3bu_2")
